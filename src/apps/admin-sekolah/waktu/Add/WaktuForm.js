...
const WaktuForm = ({ setSuccess, setError }) => {
    ...
    const mutation = useMutation({
        ...
        mutationFn: async (newWaktu) => {
            const response = await axiosInstance.post('/api/v1/waktu', newWaktu);
                ...
                <Grid container spacing={2} rowSpacing={1}>
                    <Grid item xs={12} md={6}>
                        ...
                        <TimePicker
                            ampm={false}
                            disableMaskedInput
                            value={formState.jam_mulai ? new Date(`1970-01-01T${formState.jam_mulai.replace('.', ':')}:00`) : null}
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        <TimePicker
                            ampm={false}
                            disableMaskedInput
                            value={formState.jam_selesai ? new Date(`1970-01-01T${formState.jam_selesai.replace('.', ':')}:00`) : null}
