...
const PegawaiStafEditForm = ({ stafData, handleChange, handleSubmit, handleCancel, isLoading }) => {
    ...
    const { data: subKategoriOptions = [], isLoading: isSubKategoriLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await axiosInstance.get(`/api/v1/kategori-pegawai/${stafData.kategori_pegawai_id}/subkategori`);
            return response.data.data.sort((a, b) =>
            a.nama_subkategori.localCompare(b.nama_subkategori)
        );
      },
    ...
    return (
        ...
        >
            <Box sx={{ borderRadius: 2, mt: 0 }}>
                <Grid container spacing={2} rowSpacing={1}>
                    <Grid item xs={12} md={6} >
                        <CustomFormLabel htmlFor="name" sx={{ mt: 3 }}>Nama Staf</CustomFormLabel>
                        <CustomOutlinedInput
                            id="name"
                            name="name"
                            value={stafData.name || ""}
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                            <DatePicker
                                value={stafData.tanggal_lahir || null}
                                onChange={(date) =>
            ...
            <Box sx={{ mt: 4 }}>
                <SubmitButton type="submit">Simpan Perubahan</SubmitButton>
