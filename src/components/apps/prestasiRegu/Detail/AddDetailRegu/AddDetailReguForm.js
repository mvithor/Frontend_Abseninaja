...
const TambahDetailPrestasiForm = ({ id, setSuccess, setError }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await axiosInstance.post('/prestasi-regu-siswa/tambah-prestasi', {
                id: id,
...
TambahDetailPrestasiForm.propTypes = {
    id: PropTypes.string.isRequired,
    setSuccess: PropTypes.func.isRequired,
    setError: PropTypes.func.isRequired
};

export default TambahDetailPrestasiForm;
