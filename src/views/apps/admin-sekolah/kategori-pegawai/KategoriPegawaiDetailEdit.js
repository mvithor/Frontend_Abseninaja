...
const fetchSubKategoriById = async (id, subKategoriId) => {
    try {
        const response = await axiosInstance.get(`api/v1/kategori-pegawai/${id}/subkategori/${subKategoriId}`);
...
const KategoriPegawaiDetailEdit = () => {
    ...
    const mutation = useMutation({
        ...
        return await axiosInstance.put(`api/v1/kategori-pegawai/${id}/subkategori/${subKategoriId}`, { nama_subkategori: kategori.nama_subkategori });
        },
        onSuccess: (response) => {
