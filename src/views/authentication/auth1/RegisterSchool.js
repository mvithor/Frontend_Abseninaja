...
import AuthRegisterSchool from '../authForms/AuthRegisterSchool';

const RegisterSchool = () => (
    <PageContainer title="Registrasi Sekolah" description="Registrasi Sekolah">
    ...
    >
        <Box p={4}>
            <AuthRegisterSchool
                title="Absensi Online Berbasis QR-Code"
                subtext={
